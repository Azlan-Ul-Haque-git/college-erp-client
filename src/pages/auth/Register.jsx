          ...
          <div className="flex gap-2 mb-6 bg-white/5 p-1 rounded-2xl border border-white/10">
            ...
            {ROLES.map((r) => (
              ...
              <button
                ...
                className={`flex-1 py-2 rounded-xl text-xs font-semibold transition relative overflow-hidden ${role === r.value
                  ? "text-white"
                  : "text-white/40"
                  }`}
              >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="relative col-span-2">
                ...
                <input
                  ...
                  required
                  className="w-full bg-white/10 border border-white/20 text-white placeholder-white/30 rounded-xl px-4 py-2.5 pr-10 text-sm focus:outline-none focus:border-purple-400"
                />
              ...
              {role === "student" ? (
                ...
                >
                  ...
                  >
                    ...
                    <option value="passout" className="text-black">
                      Passout
                    </option>
                  ...
                  {form.status === "backlog" && (
                    <input
                      ...
                      onChange={(e) =>
                        set("backlogCount", e.target.value)
                      }
                      className="bg-white/10 border border-white/20 text-white placeholder-white/30 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-purple-400"
                    />
                  )}
