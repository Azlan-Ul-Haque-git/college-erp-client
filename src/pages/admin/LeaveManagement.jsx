    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {[
          ...
          <div key={s.label} className="card flex flex-col items-center justify-center py-6 min-h-[120px]">
            ...
            <thead className="bg-slate-50 dark:bg-slate-700/50">
              <tr>
                {[
                  ...
                  <th
                    key={h}
                    className="text-left px-4 py-3 text-xs font-semibold text-slate-400 uppercase whitespace-nowrap"
                  >
                    {h}
                  </th>
                ))}
                ...
                leaves.map((l, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-slate-300 min-w-[220px]">
                        {l.reason}
                      </td>
